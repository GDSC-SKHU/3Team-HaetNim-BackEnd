...
-- Post 임시 저장
insert into post(create_date, last_modified_date,title, content,date, isletter,member_id)
values (CURRENT_DATE, CURRENT_DATE,'스프링 너무 어렵다~~','너무 어려워서 포기하고 싶은데 어떻하나요..?ㅠㅠㅠ', '2020-09-01',true,1);

insert into post(create_date, last_modified_date,title, content,date, isletter,member_id)
values (CURRENT_DATE, CURRENT_DATE,'jpa 너무 빡친다~','너무 어려워도 악으로 깡으로 버티세요! 그럼 언젠가는 빛을 볼거예요!!','2020-09-02',false,2);
